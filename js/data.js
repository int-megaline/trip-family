  ...
  var FOOD_AREAS = [
    {
      ...
      items: [
        { type: "특산품", name: "우메가에모찌 (梅ヶ枝餅)", shop: "かさの家 · 梅ヶ枝餅 やす武", price: "개당 150엔",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Umegaemochi_in_Dazaifu.jpg", 900),
          photoCredit: "Wikimedia Commons", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Umegaemochi_in_Dazaifu.jpg",
        ...
        { type: "간식", name: "금상 고로케 (金賞コロッケ)", shop: "あじ華 金賞コロッケ 太宰府店", price: "개당 200엔대",
          ...
          photoCredit: "Wikimedia Commons (참고용 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Korokke.jpg",
        ...
        { type: "점심", name: "참배길 정식 · 우동", shop: "참배길 식당가", price: "1인 800~1,200엔대",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Mentaiko_from_a_Fish_Market_in_Fukuoka.jpg", 900),
          photoCredit: "Wikimedia Commons (참고용 명란 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Mentaiko_from_a_Fish_Market_in_Fukuoka.jpg",
          desc: "덮밥·우동·명란 요리 등을 파는 식당이 참배길에 모여 있어 다자이후 텐만구 관람 전후로 들르기 좋습니다.",
          map: "太宰府天満宮 参道" },
        { type: "점심", name: "히타 야키소바 (日田やきそば)", shop: "마메다마치 식당가", price: "1,150엔~",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Yakisoba_(fried_noodles)_with_pork,_onions,_cabbage_and_carrot.jpg", 900),
          photoCredit: "Wikimedia Commons (참고용 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Yakisoba_(fried_noodles)_with_pork,_onions,_cabbage_and_carrot.jpg",
        ...
        { type: "점심", name: "도리텐 · 돈카츠 정식", shop: "定食家 笑 (마메다마치)", price: "900~1,200엔대",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Tonkatsu_of_Kimukatsu.jpg", 900),
          photoCredit: "Wikimedia Commons (참고용 돈카츠 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Tonkatsu_of_Kimukatsu.jpg",
    ...
    },
    {
      ...
      items: [
        { type: "간식", name: "금상 고로케 (湯布院金賞コロッケ)", shop: "湯布院金賞コロッケ 1호점·2호점", price: "개당 200엔대",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Korokke_a0.jpg", 900),
          photoCredit: "Wikimedia Commons (참고용 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Korokke_a0.jpg",
        ...
        { type: "간식", name: "치즈케이크 · 간장푸딩", shop: "由布院ミルヒ · 湯布院醤油屋 本店", price: "개당 400~500엔대",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Japanese_no-bake_cheesecake.jpg", 900),
          photoCredit: "Wikimedia Commons (참고용 치즈케이크 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Japanese_no-bake_cheesecake.jpg",
    ...
    },
    {
      ...
      items: [
        { type: "특산품", name: "지옥찜 푸딩 (地獄蒸しプリン)", shop: "岡本屋売店", price: "개당 400엔대",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Custard.jpg", 900),
          photoCredit: "Wikimedia Commons (참고용 커스터드 푸딩 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Custard.jpg",
        ...
        { type: "점심", name: "도리텐 정식 (とり天発祥の店)", shop: "レストラン東洋軒", price: "1,144~1,430엔",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Toriten.JPG", 900),
          photoCredit: "Wikimedia Commons", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Toriten.JPG",
        ...
        { type: "저녁", name: "분고규 철판 스테이크", shop: "そむり 別府本店", price: "1,500~3,000엔대",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Beef_steak_(11888070325).jpg", 900),
          photoCredit: "Wikimedia Commons (참고용 스테이크 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Beef_steak_(11888070325).jpg",
    ...
    },
    {
      ...
      items: [
        { type: "간식", name: "아소 우유 소프트아이스크림", shop: "道の駅 阿蘇 · ASOMILK", price: "개당 400~500엔대",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Soft_Ice_cream.jpg", 900),
          photoCredit: "Wikimedia Commons (참고용 소프트아이스크림 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Soft_Ice_cream.jpg",
          desc: "아소 초원에서 자란 소의 우유로 만든 진한 소프트아이스크림으로, 구사센리 방문 전후로 들르기 좋습니다.",
          map: "道の駅 阿蘇" },
        { type: "점심", name: "가라아게 정식", shop: "阿蘇 丸福", price: "880엔",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Chicken_karaage_003.jpg", 900),
          photoCredit: "Wikimedia Commons (참고용 가라아게 이미지)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Chicken_karaage_003.jpg",
        ...
        { type: "점심", name: "아카규동 (あか牛丼)", shop: "いまきん食堂 · あか牛丼いわさき", price: "1,850~1,960엔",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Yoshinoya_Beef_Bowl.JPG", 900),
          photoCredit: "Wikimedia Commons (참고용 규동 이미지, 실제 아카규 사진 아님)", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Yoshinoya_Beef_Bowl.JPG",
    ...
    },
    {
      ...
      items: [
        ...
        { type: "점심", name: "명란 요리 · 우동", shop: "하카타역 구내 식당가", price: "700~1,000엔대",
          photo: wmThumb("https://commons.wikimedia.org/wiki/File:Hakata_udon.JPG", 900),
          photoCredit: "Wikimedia Commons", photoCreditUrl: "https://commons.wikimedia.org/wiki/File:Hakata_udon.JPG",
